...
const Chatbot = () => {
  ...
  if (!isOpen) {
    return (
      <Button
        ...
        className="fixed bottom-6 right-6 h-14 w-14 rounded-full gradient-primary shadow-lg z-50"
        size="icon"
      >
  ...
  return (
    <Card className="fixed bottom-6 right-6 w-96 h-[500px] glass border-none shadow-xl z-50 flex flex-col">
